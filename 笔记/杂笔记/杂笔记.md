...
amend = revise修改  ---- advise建议

**alteration** = variation = change = conversion --- converse相反 谈话

affecting动人的 = impressive

from base to tip = **from bottom to top**

associate ---反义--- dissociate分离 单独

take the place of = replace

make mind up 下定决心  = **determination** = **resolution**决议决心

immediate立刻的 = instant 

**spectacular**壮观的/令人惊叹的 = dramatic

straightforward = easy

move around四处奔波 = mobile

be in accordance with 与一致/根据按照 = according to
